	...
	// Now, let's try to create some invalid alert rules.
	{
		testCases := []struct {
			...
			},
			{
				...
				expectedResponse: `{"message":"failed to validate alert rule AlwaysFiring: invalid label: label 1; label keys should not contain spaces"}`,
			},
			{
				...
				expectedResponse: `{"message":"failed to validate alert rule AlwaysFiring: invalid annotation: annotation 1; annotation keys should not contain spaces"}`,
			},
		}
